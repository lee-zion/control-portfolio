...
double	phicTable[3] = {0, PI/8.0, PI/4.0};
...
void SaveResult(void)
{
	...
	//	fprintf( pFile, "   Time\t\t\tphic\t\t\tphi\t\t\tp\t\t\tdeltac\t\t\tdelta\n");

	for (int PRINTER = 0; PRINTER <= Tfinal/Ts; PRINTER++)
